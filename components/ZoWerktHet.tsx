      ...
      {open && (
        <div className="border-t border-foreground/10 px-4 py-3 text-sm text-foreground/90">
          <ol className="list-decimal space-y-2 pl-4">
            ...
            <li>
              <strong>4 t/m 7 februari</strong> – Fruitautomaat: elke dag 1 spin (vanaf 10:00). De 3 steden in de spin krijgen elk <strong>1 punt</strong> (4–6 feb) of <strong>3 punten</strong> (7 feb en finale) – dus 3 of 9 punten per spinronde. De <strong>tussentand</strong> zie je live; op 7 februari om 20:00 volgt de finale.
            </li>
            <li>
              <strong>7 februari 20:00</strong> – Finale. Druk op “Bekijk de uitslag” – dan weten we het. Daar gaan we heen!
            </li>
          </ol>
          <p className="mt-3 rounded border border-foreground/15 bg-foreground/5 px-3 py-2 text-xs italic text-foreground/80">
            <strong>Eerlijk spel:</strong> Erik en Benno hebben allebei dezelfde rechten. Niemand kan de uitslag sturen: jullie kiezen elk je eigen steden, strepen elk je eigen keuzes weg, en de fruitautomaat kiest willekeurig. Met 1 of 3 punten per getoonde stad (vanaf 7 feb) en 4 spins per persoon blijft de race spannend; een stad kan wel eerder mathematisch niet meer ingehaald worden, maar tot de laatste spin is er van alles mogelijk.
          </p>
        </div>
      )}
    </div>
